...
function Mobile({ open }) {
  return <div className={`w-[250px] z-50 absolute left-0 top-0 items-center p-2 flex-col bg-blue-950 h-screen gap-1
...
function Desktop() {
  return <div className={`w-[300px] relative items-center p-2 flex-col bg-blue-950 h-screen gap-1 hidden lg:flex`}>
    <div className='flex gap-1 mt-3 justify-start items-center'>
      <img src="./image.png" alt="" className='w-10 rounded-sm h-10' />
      <div className='ml-2 flex flex-col'>
        <h1 className='text-xl text-white font-semibold'>Tilak-csd</h1>
